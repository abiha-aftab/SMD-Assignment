package com.example.personalresume.activities;
...
import com.example.personalresume.adapters.ViewPagerAdapter;
import com.example.personalresume.R;
import com.example.personalresume.fragments.AboutFragment;
import com.example.personalresume.fragments.EducationFragment;
import com.example.personalresume.fragments.ProfessionFragment;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            i.putExtra(android.content.Intent.EXTRA_TEXT, "https://abiha-aftab.github.io/");
